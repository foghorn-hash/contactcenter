...
var Ajax = XHR.extend({
// -------------------------------------------------------
// Clean is new option for Ajax loadingscreen effect 
// by Matti Kiviharju at http://framework.teknologiaplaneetta.com/
// ---------------------------------------------------
	options: {
		data: null,
		update: null,
	...
	onComplete: function(){
		...
		if (this.options.clean) $(this.options.clean).empty().setHTML(); // new option for loadingscreen
